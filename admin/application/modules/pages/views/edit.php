        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    <?php echo form_input('title', set_value('title', $page->title), array('class' => 'form-control input-lg', 'placeholder' => 'Title')); ?>
                </div>

                <div class="form-group">
                    <?php echo form_textarea('content', set_value('content', $page->content, FALSE), array('class' => 'form-control editor')); ?>
                </div>
            </div>
        </div>
    </div>
