...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge">
	    <title>Konsultasi - Kemendesa</title>
	    <!-- start:stylesheet -->
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md" id="navbarCollapse">
                        <a class="navbar-brand" href="#">
                            <img src="<?php echo base_url('public/images/portal/logo_kader.png') ?>" alt="">
                        </a>
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item active">
                                <a href="<?php echo base_url('konsultasi/index.php/konsultasi') ?>" class="nav-link">KONSULTASI</a>
                            </li>
                            <li class="nav-item">
