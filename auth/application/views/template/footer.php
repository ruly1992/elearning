    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="footer-top-left">
                        <ul>
                            <li><i class="fa fa-clock-o"></i> <?php echo Carbon\Carbon::today()->format('d F Y') ?></li>
        ...
        <div class="footer-logo">
            <div class="text-center">
                <a href="<?php echo home_url() ?>"><img src="<?php echo asset('images/portal/logo_portal_bottom.png') ?>" alt=""></a>
            </div>
        </div>
        <!-- end:footer logo -->
        <!-- start:footer bottom -->
