        ...
        <div class="elib-content-single-list-main">
            <ul>
                ...
                <?php foreach ($results as $media): ?>
                    <li><a href="#"><?php echo $media->file_name ?></a> <small><i class="fa fa-calendar"></i> <?php echo $media->created_at->format('d/m/Y') ?> - <?php echo $media->icon ?> <?php echo $media->type ?></small></li>
                <?php endforeach ?>
                <?php else: ?>
